...
$config=Array
	(
	'title'=>'PicLite - 无数据库图床',
	'keywords'=>'PicLite,图床,无数据库图床,自托管图床,Docker图床,图片上传,markdown,bbscode',
	'description'=>'PicLite 是一款轻量的无数据库自托管图床,支持多文件上传、图片直链、Markdown、BBCode、HTML、API上传和Docker部署。',
	'tips'=>'<a href="https://github.com/Lau0x/piclite" target="_black"><i class="icon icon-github"> PicLite 是一个轻量无数据库图床</i></a>
<a href="https://github.com/icret/EasyImages2.0" target="_black"><i class="icon icon-heart"> 基于 EasyImages2.0 继续维护, 感谢原作者 Icret</i></a>
<a><li class="icon icon-bullhorn text-muted"> 单文件≤10M,单次上传≤30张</li></a>',
	'notice_status'=>0,
	'notice'=>'<p>PicLite 是一款轻量的无数据库自托管图床。</p>
<p>项目基于 EasyImages2.0 继续维护, 默认保留旧路径和部署兼容性。</p>',
	...
	'extensions'=>'jpg,jpeg,png,gif,bmp,webp,ico,jfif',
	'compress'=>0,
	'compress_ratio'=>80,
	'thumbnail'=>1,
	'thumbnail_w'=>258,
	...
	'static_cdn'=>0,
	'theme'=>'default',
	'static_cdn_url'=>'https://fastly.jsdelivr.net/gh/Lau0x/piclite',
	'TinyPng_key'=>'',
	'checkImg'=>0,
	'checkImg_value'=>80,
	'moderatecontent_key'=>'',
...
<h5>PicLite 是基于 EasyImages2.0 继续维护的无数据库图床, 默认保留旧路径和部署兼容性;</h5>
<h5>更改配置或内容应注意闭合标签, 否则可能导致页面显示不全或者功能异常;</h5>
<a href="https://github.com/Lau0x/piclite/issues" target="_blank"><button type="button" class="btn btn-mini"><i class="icon icon-comments-alt"></i> 反馈</button></a>
<a href="https://github.com/icret/EasyImages2.0" target="_blank"><button type="button" class="btn btn-mini"><i class="icon icon-heart"></i> 上游项目</button></a>
</div>',
